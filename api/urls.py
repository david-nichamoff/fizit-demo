...
urlpatterns = [
    ...
    path('contracts/<int:contract_idx>/parties/', views.PartyViewSet.as_view({'get':'list_contract','post':'add','delete':'delete_contract'}), name='contract-parties'),
    ...
    path('contracts/<int:contract_idx>/transactions/', views.TransactionViewSet.as_view({'get':'list_contract','post':'add','delete':'delete_contract'}), name='contract-transactions'),
    ...
    path('contracts/<int:contract_idx>/settlements/', views.SettlementViewSet.as_view({'get':'list_contract','post':'add','delete':'delete_contract'}), name='contract-settlements'),
    path('contracts/<int:contract_idx>/artifacts/', views.ArtifactViewSet.as_view({'get':'list_contract','post':'add','delete':'delete_contract'}), name='contract-artifacts'),
