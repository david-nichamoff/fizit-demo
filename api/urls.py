...
urlpatterns = [
    ...
    path('contracts/<int:contract_idx>/tickets/', TicketViewSet.as_view({'get':'list','post':'process'}), name='contract-tickets'),
    path('contracts/<int:contract_idx>/invoices/', InvoiceViewSet.as_view({'get':'list'}), name='contract-invoices'),
