...
from api.operations import (
    ContractOperations, PartyOperations, SettlementOperations, TransactionOperations,
...
class AdvanceContractEncryptionTest(TestCase):
    def setUp(self):
    ...
    def test_advance_contract_encryption_flow(self):
        ...
        # 5. Retrieve and verify with MASTER_KEY (should be decrypted)
        ...
        # 7. Add affiliate party to the contract using MASTER_KEY
        self._initialize_operations(self.fizit_headers)
