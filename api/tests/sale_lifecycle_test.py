...
class SaleLifecycleTest(TestCase):
    @classmethod
    ...
    def test_contract_lifecycle(self):
        ...
        # Calculations not applicable for sale contracts
    ...
    def _validate_event(self, contract_idx, event_type):
        ...
        for attempt in range(retries):
            events = self.event_ops.get_events(contract_type="sale", contract_idx=contract_idx, to_addr=to_addr)
