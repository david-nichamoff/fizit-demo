...
class PurchaseAuthorizationTest(TestCase):

    @classmethod
    def setUpTestData(cls):
        """Load authorization test data from purchase fixture file."""
    ...
    def setUp(self):
        ...
        log_info(self.logger, "Setting up test environment for purchase contract...")
        ...
        log_info(self.logger, "Purchase contract test environment setup complete.")
    ...
    def test_authorization_failures(self):
        """Run authorization tests for purchase contracts, parties, and transactions."""
        try:
            log_info(self.logger, "Starting authorization tests for purchase contract...")
            ...
            log_info(self.logger, "All authorization tests for purchase contract passed.")
        except AssertionError as e:
            log_error(self.logger, f"Authorization test for purchase contract failed: {e}")
            raise

    def _test_contract_authorization(self):
        """Test authorization for creating purchase contracts."""
        log_info(self.logger, "Testing purchase contract authorization...")
        contract_idx = None
    ...
    def _test_party_authorization(self, contract_idx):
        """Test authorization for party-related operations in purchase contract."""
        log_info(self.logger, "Testing party authorization for purchase contract...")
    ...
    def _test_transaction_authorization(self, contract_idx):
        """Test authorization for transaction-related operations in purchase contract."""
        log_info(self.logger, "Testing transaction authorization for purchase contract...")
