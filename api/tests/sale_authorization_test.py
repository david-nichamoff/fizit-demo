...
class SaleAuthorizationTest(TestCase):
    ...
    def test_authorization_failures(self):
        """Run authorization tests for sale contracts, parties, settlements, and transactions."""
        try:
            log_info(self.logger, "Starting authorization tests for sale contract...")
            ...
            log_info(self.logger, "All authorization tests for sale contract passed.")
        except AssertionError as e:
            log_error(self.logger, f"Authorization test for sale contract failed: {e}")
            raise

    def _test_contract_authorization(self):
        """Test authorization for creating sale contracts."""
        log_info(self.logger, "Testing sale contract authorization...")
        contract_idx = None
    ...
    def _test_party_authorization(self, contract_idx):
        """Test authorization for party-related operations in sale contract."""
        log_info(self.logger, "Testing party authorization for sale contract...")
    ...
    def _test_settlement_authorization(self, contract_idx):
        """Test authorization for settlement-related operations in sale contract."""
        log_info(self.logger, "Testing settlement authorization for sale contract...")
    ...
    def _test_transaction_authorization(self, contract_idx):
        """Test authorization for transaction-related operations in sale contract."""
        log_info(self.logger, "Testing transaction authorization for sale contract...")
