...
class AdvanceAuthorizationTest(TestCase):

    @classmethod
    def setUpTestData(cls):
        """Load authorization test data from advance fixture file."""
    ...
    def setUp(self):
        ...
        log_info(self.logger, "Setting up test environment for advance contract...")
        ...
        log_info(self.logger, "Advance contract test environment setup complete.")
    ...
    def test_authorization_failures(self):
        """Run authorization tests for advance contracts, parties, settlements, and transactions."""
        try:
            log_info(self.logger, "Starting authorization tests for advance contract...")
            ...
            log_info(self.logger, "All authorization tests for advance contract passed.")
        except AssertionError as e:
            log_error(self.logger, f"Authorization test for advance contract failed: {e}")
            raise

    def _test_contract_authorization(self):
        """Test authorization for creating advance contracts."""
        log_info(self.logger, "Testing advance contract authorization...")
        contract_idx = None
        ...
        for scenario in self.scenarios:
            ...
            contract['contract_name'] = 'Advance Authorization Test'
            response = self._perform_operation(self.contract_ops.post_contract, self.contract_type, contract)
            log_info(self.logger, f"Advance contract scenario {scenario['key']} returned: {response}")
    ...
    def _test_party_authorization(self, contract_idx):
        """Test authorization for party-related operations in advance contract."""
        log_info(self.logger, "Testing party authorization for advance contract...")
    ...
    def _test_settlement_authorization(self, contract_idx):
        """Test authorization for settlement-related operations in advance contract."""
        log_info(self.logger, "Testing settlement authorization for advance contract...")
    ...
    def _test_transaction_authorization(self, contract_idx):
        """Test authorization for transaction-related operations in advance contract."""
        log_info(self.logger, "Testing transaction authorization for advance contract...")
