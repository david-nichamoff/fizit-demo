...
urlpatterns = [
    ...
    path('contracts/<int:contract_idx>/transactions/<int:transact_idx>', views.TransactionViewSet.as_view({'get':'get','delete':'delete'}), name='contract-transaction'),
    ...
    path('contracts/<int:contract_idx>/settlements/<int:settle_idx>', views.SettlementViewSet.as_view({'get':'get','delete':'delete'}), name='contract-settlement'),
