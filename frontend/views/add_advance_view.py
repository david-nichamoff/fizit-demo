...
def fetch_all_advances(headers, context, base_url,csrf_token):
    ...
    for contract_type in contract_types:
        if context.api_manager.get_advance_api(contract_type):
...
def add_advance_view(request, extra_context=None):
    ...
    advances = fetch_all_advances(headers, context, base_url, csrf_token)
    ...
    return render(request, "admin/add_advance.html", form_context)