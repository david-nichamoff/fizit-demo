...
def add_artifacts(contract_idx, contract_name, artifact_path, artifact_files):
    ...
    for artifact_file in artifact_files:
        ...
        if response.status_code == 201: 
            ...
            call_function = w3_contract.functions.addArtifact(contract_idx, artifact_id).build_transaction({"from":env_var["wallet_addr"],"nonce":nonce})
